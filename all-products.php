        ...
        ?>
             ...
             <?php } ?>
                    ...
                    <div class="travel_image_hover">
                        ...
                        <img src="uploads/thumb/<?php echo $result->pp_path; ?>" alt="Prestige-bengal-logo">
                        </a>
                    ...
                    <a class="btn btn-primary" href="<?php echo baseurl; ?><?php echo $result->p_url; ?>" type="button">View Details</a></p>                        
                      <div class="feature_product_txt"><span class="cutline">Tk.<?php echo $result->prc_price; ?> </span>  &nbsp; Tk.<?php echo $result->descountprice; ?> </div>   
