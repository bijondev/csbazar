...
<table>
	...
	<tr>
		<td colspan="3"><span class="label label-important">Picture size: width-700px and Height-300px</span></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
		<td> <input class="btn btn-small btn-success" type="submit" name="edit-banner-picture" value="Save" > </td>
	</tr>
</table>
</form>
</div>
