<?php
        $sql = "SELECT p.p_id, p.p_name, m.mr_company_name, c.pc_name, m.mr_id,
...
DATE_FORMAT(p.p_published_to_date,'%b %d %Y %h:%i:%s') as Dayleft,
                ...
                <div class="span3">
                   <h6>Original Price Starts From <?php echo $result->p_original_price; ?> Taka </h6>
                      ...
                      <p>
                        Day Left To Buy
                        <br />
                        <span date-type="counter" data-index="<?php echo $result->p_id; ?>" date-value="<?php echo $result->Dayleft; ?>" class="countdown3"></span>
                  ...
                  <a class="btn btnd btn-inverse bigbutton effect6" href="<?php echo baseurl; ?>deals-view/<?php echo $result->mr_id; ?>" type="button">View Details &amp; Buy</a>
                </div>
                </div>
             </div> 
<?php } ?>